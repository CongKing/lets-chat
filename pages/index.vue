<template>
   <div>
     ...
     <wv-tabbar>
      <wv-tabbar-item to="/chats" :isOn="activeTab === 'chats'" @click="switchTab('chats')">
      ...
      <wv-tabbar-item to="/contacts" :isOn="activeTab === 'contacts'" @click="switchTab('contacts')">
      ...
      <wv-tabbar-item to="/discover" :isOn="activeTab === 'discover'" @click="switchTab('discover')">
        <span slot="icon" style="display: inline-block; position: relative;">
      ...
      <wv-tabbar-item to="/profile" :isOn="activeTab === 'profile'" @click="switchTab('profile')">
